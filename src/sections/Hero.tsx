         ...
         <div className="container">
            <div className='md:flex items-center'>
               <div className='md:w-[478px]'>
                  ...
                  <h1 className="text-5xl md:text-7xl  font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-6 ">Pathwway to productivity </h1>
               ...
               <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative '>
                  ...
                  />
                  <motion.img src={noodleImage.src} alt='noodle image' width={220} height={220} className='hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]' 
                  style={{
                     rotate: 30,
                     translateY: translateY
                  }}
